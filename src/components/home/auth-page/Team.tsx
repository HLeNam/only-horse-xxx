        ...
        <section className="container py-24 sm:py-32 mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 gap-y-10">
                {teamList.map(({ description, imageUrl, name, position }) => (
                    ...
                    >
                        <CardHeader className="my-8 flex justify-center items-center flex-col">
                            ...
                            />
                            <CardTitle className="text-center text-nowrap">{name}</CardTitle>
                            <CardDescription className="text-primary text-nowrap">
                                {position}
                            </CardDescription>
                        </CardHeader>
